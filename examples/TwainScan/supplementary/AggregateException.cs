// Partial of .NET Framework 4.5.2 AggregateException
// http://referencesource.microsoft.com/#mscorlib/system/AggregateException.cs
// ==++==
//
...
namespace System
{
    ...
    public class AggregateException : Exception
    {
            ...
            base(info, context)
        {
            ...
            if (innerExceptions == null)
            {
                throw new SerializationException("The exception could not be deserialized correctly.");
            }
